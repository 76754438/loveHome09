...
func init() {
	...
	//让beego的orm模块连接数据库
	//数据库的别名 数据库的类型 用户名和密码@/连接方式(IP:数据库的端口号)/mysql数据库的名字？编码方式 ,允许客户端连接的数量
	orm.RegisterDataBase("default", "mysql", "root:123456@tcp(127.0.0.1:3306)/lovehome09?charset=utf8", 30)
